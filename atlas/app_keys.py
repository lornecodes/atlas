...
TRIGGER_STORE: web.AppKey[Any] = web.AppKey("trigger_store")
TRIGGER_SCHEDULER: web.AppKey[Any] = web.AppKey("trigger_scheduler")
SECURITY_POLICY: web.AppKey[Any] = web.AppKey("security_policy")
SKILL_REGISTRY: web.AppKey[Any] = web.AppKey("skill_registry")
FILE_REGISTRY_PROVIDER: web.AppKey[Any] = web.AppKey("file_registry_provider")
